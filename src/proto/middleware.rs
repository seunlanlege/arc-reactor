...
/// In arc-reactor the middleware system is designed to be as intuitive and as
/// simple as possible.
///
/// # How it works.
///
...
///
/// # Note
/// Please note that you would probably never have a reason to implement this
/// trait on your type directly.
///
/// Instead you'll use the middleware proc_macro
/// [`#[middleware]`](../impl_service/fn.middleware.html) to decorate your
...
/// This enables a vector of `MiddleWare<Request>` to behave like a single
